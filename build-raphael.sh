...
# 使用 raphael_defconfig
make CC=clang O=out ARCH=arm64 LLVM=1 LLVM_IAS=1 raphael_defconfig
...
echo "Xiaomi 9 (raphael) kernel with KernelSU" > AnyKernel3/README.md
...
echo ">create zip"
cd AnyKernel3
zip -r9 ../AnyKernel3-${DEVICE}-${ANDROID_VERSION}.zip .
cd $BASE_PATH
